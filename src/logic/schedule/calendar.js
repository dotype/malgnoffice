    ...
    data() {
        ...
        return {
            ...
            events: [
                ...
                { id: 'v21', date: `${y}-03-24`, title: '장태우 연차', type: 'vacation', subtype: 'full' },
                { id: 'v22', date: `${y}-03-24`, title: '최현희 오후반차', type: 'vacation', subtype: 'pm' },
                { id: 'v23', date: `${y}-03-25`, title: '최현희 오전반차', type: 'vacation', subtype: 'am' },
                { id: 'v24', date: `${y}-03-26`, title: '권지혜 오전반차', type: 'vacation', subtype: 'am' },
                ...
                { id: 's5', date: `${y}-03-06`, title: '10:00 외부미팅 - 정보산업진흥원', type: 'schedule' },
                { id: 's6', date: `${y}-03-09`, title: '10:30 경영진 회의', type: 'schedule' },
                { id: 's7', date: `${y}-03-09`, title: '14:00 회의 - 크리에이티브LMS', type: 'schedule' },
                { id: 's8', date: `${y}-03-09`, title: '15:00 점미팅 - 마니트', type: 'schedule' },
                { id: 's9', date: `${y}-03-10`, title: '10:00 에듀킬 고객사 환경구축', type: 'schedule' },
                { id: 's10', date: `${y}-03-10`, title: '10:30 경영진 회의', type: 'schedule' },
                { id: 's11', date: `${y}-03-10`, title: '14:00 리더십 피드백 미팅', type: 'schedule' },
                { id: 's12', date: `${y}-03-10`, title: '14:00 면접 - 손○○', type: 'schedule' },
                { id: 's13', date: `${y}-03-10`, title: '15:00 면접 - 미○○', type: 'schedule' },
                { id: 's14', date: `${y}-03-10`, title: '16:00 화상미팅 - 한경모집', type: 'schedule' },
                { id: 's15', date: `${y}-03-11`, title: '10:00 환금결영팀 벅스터디', type: 'schedule' },
                { id: 's16', date: `${y}-03-11`, title: '11:00 외부미팅 - 연합w스경제', type: 'schedule' },
                { id: 's17', date: `${y}-03-12`, title: '09:00 회의 - 크리에이티브LMS', type: 'schedule' },
                { id: 's18', date: `${y}-03-12`, title: '10:00 컨설팅 벅스터디', type: 'schedule' },
                { id: 's19', date: `${y}-03-16`, title: '10:00 1차면접 [컨설팅]', type: 'schedule' },
                { id: 's20', date: `${y}-03-17`, title: '14:00 팀장 코칭 - 최현희', type: 'schedule' },
                { id: 's21', date: `${y}-03-17`, title: '14:00 외부미팅 - 콜렉시스', type: 'schedule' },
                { id: 's22', date: `${y}-03-17`, title: '15:30 리더십 코칭 - 이윤석', type: 'schedule' },
                { id: 's23', date: `${y}-03-25`, title: '07:00 정기 배포 [컴플클라우드]', type: 'schedule' },
                { id: 's24', date: `${y}-03-27`, title: '17:00 환급 LMS 스킨 매칭', type: 'schedule' },

                // 교육
                { id: 'e1', date: `${y}-03-04`, title: '14:00 팀장 리더십 교육', type: 'education' },
                { id: 'e2', date: `${y}-03-04`, title: '16:00 환급 고객사 교육', type: 'education' },
                { id: 'e3', date: `${y}-03-04`, title: '16:00 코드리뷰', type: 'education' },
                { id: 'e4', date: `${y}-03-06`, title: '13:00 LMS 교육 - 드론확산협회', type: 'education' },
                { id: 'e5', date: `${y}-03-06`, title: '14:00 OMP 영업 교육', type: 'education' },
                { id: 'e6', date: `${y}-03-10`, title: '13:00 LMS 교육 - 드론확산협회', type: 'education' },
                { id: 'e7', date: `${y}-03-12`, title: '14:00 LMS 교육 - 한국웰에이징', type: 'education' },
                { id: 'e8', date: `${y}-03-12`, title: '15:30 팀장 코칭 - 나혜진', type: 'education' },
                { id: 'e9', date: `${y}-03-19`, title: '14:00 셀프리더십 교육 (A조)', type: 'education' },
                { id: 'e10', date: `${y}-03-19`, title: '15:00 셀프리더십 교육 (B조)', type: 'education' },
            ],
            showAddMenu: false,
            majorEvents: [
                { id: 1, title: '전사정례회의', datetime: '2026년 03월 04일 (수) 10:30 ~ 13:00' },
                { id: 2, title: '전사정례회의', datetime: '2026년 04월 01일 (수) 10:30 ~ 13:00' }
            ]
        };
    },
    computed: {
